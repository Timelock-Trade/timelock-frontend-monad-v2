export const TRADE_EXECUTE_ABI = [
    ...
    "outputs": [
      {
        "name": "",
        "type": "address",
        "internalType": "contract ITimelockV2ClammFeeStrategyV2"
      }
    ],
    "stateMutability": "view"
  },
    ...
    "inputs": [
      {
        "name": "_params",
        "type": "tuple",
        "internalType": "struct TimelockV2OptionMarketV2.ExerciseOptionParams",
        "components": [
          {
            "name": "optionId",
            "type": "uint256",
    ...
    "outputs": [
      {
        "name": "ac",
        "type": "tuple",
        "internalType": "struct TimelockV2OptionMarketV2.AssetsCache",
        "components": [
          {
            "name": "assetToUse",
            "type": "address",
    ...
    "inputs": [
      {
        "name": "_params",
        "type": "tuple",
        "internalType": "struct TimelockV2OptionMarketV2.OptionParams",
        "components": [
          {
            "name": "optionTicks",
            "type": "tuple[]",
            "internalType": "struct TimelockV2OptionMarketV2.OptionTicks[]",
            "components": [
              {
                "name": "_handler",
                "type": "address",
    ...
    "outputs": [
      {
        "name": "",
        "type": "address",
        "internalType": "contract ITimelockV2PositionManager"
      }
    ],
    "stateMutability": "view"
  },
    ...
    "inputs": [
      {
        "name": "_params",
        "type": "tuple",
        "internalType": "struct TimelockV2OptionMarketV2.PositionSplitterParams",
        "components": [
          {
            "name": "optionId",
            "type": "uint256",
    ...
    "inputs": [
      {
        "name": "_params",
        "type": "tuple",
        "internalType": "struct TimelockV2OptionMarketV2.SettleOptionParams",
        "components": [
          {
            "name": "optionId",
            "type": "uint256",
  ...
  {
    "type": "error",
    "name": "TimelockV2OptionMarket__ArrayLenMismatch",
    "inputs": []
  },
  {
    "type": "error",
    "name": "TimelockV2OptionMarket__EmptyOption",
    "inputs": []
  },
  {
    "type": "error",
    "name": "TimelockV2OptionMarket__IVNotSet",
    "inputs": []
  },
  {
    "type": "error",
    "name": "TimelockV2OptionMarket__InvalidPool",
    "inputs": []
  },
  {
    "type": "error",
    "name": "TimelockV2OptionMarket__MaxCostAllowanceExceeded",
    "inputs": []
  },
  {
    "type": "error",
    "name": "TimelockV2OptionMarket__MaxOptionBuyReached",
    "inputs": []
  },
  {
    "type": "error",
    "name": "TimelockV2OptionMarket__NotApprovedSettler",
    "inputs": []
  },
  {
    "type": "error",
    "name": "TimelockV2OptionMarket__NotEnoughAfterSwap",
    "inputs": []
  },
  {
    "type": "error",
    "name": "TimelockV2OptionMarket__NotIVSetter",
    "inputs": []
  },
  {
    "type": "error",
    "name": "TimelockV2OptionMarket__NotOwnerOrDelegator",
    "inputs": []
  },
  {
    "type": "error",
    "name": "TimelockV2OptionMarket__NotValidStrikeTick",
    "inputs": []
  },
  {
    "type": "error",
    "name": "TimelockV2OptionMarket__OptionExpired",
    "inputs": []
  },
  {
    "type": "error",
    "name": "TimelockV2OptionMarket__OptionNotExpired",
    "inputs": []
  },
  {
    "type": "error",
    "name": "TimelockV2OptionMarket__PoolNotApproved",
    "inputs": []
  },
